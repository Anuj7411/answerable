---
"@answerable-kit/templates": minor
---

Scaffold the `@answerable-kit/templates` package — the fifth workspace package — and ship its first five page templates plus the token-substitution engine:
