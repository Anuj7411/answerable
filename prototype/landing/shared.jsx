...
function Bloom(props) {
  ...
  React.useEffect(function () {
    if (ref.current && window.mountBloom) {
      window.mountBloom(ref.current, props.opts || {});
    }
  }, []);
  return <canvas className="bloom" ref={ref} />;
}
...
Object.assign(window, { Bloom, GitHubIcon, GoogleIcon });
