...
- d7c2eba: Scaffold the `@answerable/templates` package — the fifth workspace package — and ship its first five page templates plus the token-substitution engine:
