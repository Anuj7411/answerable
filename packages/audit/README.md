...
The audit engine for the [Answerfox](https://github.com/Anuj7411/answerfox) SEO toolkit. Fetches a target URL, parses the HTML, runs every registered check in parallel, and returns a structured report with score, severity-grouped findings, evidence, and fix recommendations.
