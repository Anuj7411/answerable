...
- 7e0026d: Scaffold `@answerable/cli` — the seventh and final library package — exposing the `answerable` command. Wraps the audit engine for terminal and CI use.
...
- 66dc148: Add two new CLI commands that wire `@answerable/templates` into the developer flow:
...
- Updated dependencies [d7c2eba]
  - @answerable/audit@0.1.0
  - @answerable/core@0.1.0
  - @answerable/templates@0.1.0
